...
function App() {
  ...
  return (
    <div className="tt-app">
      <nav className="navbar sticky-top tt-navbar" aria-label="Primary">
        <div className="container-fluid tt-navbar-inner">
          <span className="navbar-brand tt-brand">
            <span aria-hidden="true" className="tt-brand-icon">🎫</span> TokTickIT
          </span>
          <RequesterSelector />
        </div>
      </nav>
