...
// Lab 1 foundation screen — kept so the original check-system demo stays
// valid. In Lab 3 it renders as the authenticated shell's fallback body;
// the component itself is identity-agnostic (public read-only endpoints).
